...
public class ArrayLists01 {
    public static void main(String[] args) {
        ...
        System.out.println(ages);//[9, 656,8, 9, 10, 12, 777, 10, 888, 8, 9, 10] ==>sondakileri silmedi sadece araya ekleme yapti ondan sondaki 8 9 10 silinmedi
...
//        System.out.println(ages);
        ...
        names.clear();// burada sepeti bosalttik

        //2. yol Recommended (tavsiye edilir demek)
